# Chapter 32 Debugging, Review, And Extension: Systemd Packages

This lesson helps you review and extend **Systemd Packages** instead of stopping at the first working example.
